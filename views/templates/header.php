        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex-shrink-0 flex items-center">
                ...
                <div class="hidden md:flex space-x-8">
                    ...
                    <a href="<?= BASEURL; ?>/katalog" class="<?= ($data['aktif'] == 'katalog') ? 'text-emerald-600 font-bold border-b-2 border-emerald-600 pb-1' : 'text-slate-600 hover:text-emerald-600 font-medium transition pb-1' ?>">Mitra</a>
